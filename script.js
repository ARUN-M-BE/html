...
print("✅ Array of Fruits: " + fruits.push("orange", "4").toString().charAt(0).toUpperCase() + fruits.slice(1).find(fruit => fruit === "4") + ", " + fruits.join(", "));
...
print("✅ All Students:");
students.forEach(s => print(`🔹 ${s.name}, Age ${s.age}, Courses: ${s.courses.join(", ")}`));
